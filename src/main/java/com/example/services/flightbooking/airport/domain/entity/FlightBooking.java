...
public class FlightBooking {
	...
	@GenericGenerator(name = "booking-id-gen", parameters = @Parameter(name = "prefix", value = "FB"), strategy = "com.example.services.flight-booking.domain.util.StringSequenceIdGenerator")
	private String id;
